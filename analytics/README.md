...
The storefront publishes 61 custom events through `Shopify.analytics.publish` —
...
| File | What it is |
| --- | --- |
| `custom-pixel.js` | Paste into Settings → Customer events. Subscribes to all 61 events and forwards five fields. |
