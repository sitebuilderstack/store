...
> ## ⚠ Archives attached — delivery still unproven until a test order
>
> **Updated 14 September 2026 (evening).** The owner has attached the archives
> in the Digital Products app for all seven products, including the two added
> today. **The Admin API cannot see attachments**: the app stores files
> privately, so `scripts/verify-digital-delivery.py` reports delivery as
> unproven for seven of the eight products, and will until a paid order for
> each reaches FULFILLED with a working download.
>
> | Product | Price | Archive to have attached | SHA-256 |
> | --- | --- | --- | --- |
> | Claude Code Website Launch System | $19.99 | `claude-code-website-launch-system-v1.0.zip` | `0e432c8a…291ac0` (delivery proven by order #1001) |
> | SEO & Website Audit Toolkit | $19.99 | `claude-code-seo-website-audit-toolkit-v1.0.zip` | `559ddca3…1aa7aed` (rebuilt 13 Sep with the new prices) |
> | Conversion & Revenue Optimization Toolkit | $19.99 | `claude-code-conversion-revenue-optimization-toolkit-v1.0.zip` | `2bffc3cd…41f657d` (rebuilt 13 Sep) |
> | Complete Site Builder Stack | $39.99 | the three above, as three attachments | — |
> | Website Operations & Maintenance System | $39.99 | `claude-code-website-operations-maintenance-system-v1.0.zip` | `f48b88fe…3210c` |
> | Shopify Automation & Admin API Toolkit | $39.99 | `claude-code-shopify-automation-admin-api-toolkit-v1.0.zip` | `813cb823…c5675f` |
> | Website Migration & Replatforming System | $29.99 | `claude-code-website-migration-replatforming-system-v1.0.zip` | `11a313c4…b77bce` |
> | Agency & Client Delivery System | $39.99 | `claude-code-agency-client-delivery-system-v1.0.zip` | `8fe8d23f…39c1b5` |
>
> **The one remaining step:** place a real test order for each product
> (refund afterwards), open the download link in the confirmation, and check
> the file's SHA-256 against the table. If the SEO or CRO archive's hash does
> not match, the attached copy is the pre-13-September build with the old
> prices inside — re-upload from `dist/`.
>
> ---
>
