...
selling seven digital products, published as a worked example of building and running
...
the **Website Operations & Maintenance System** ($39.99), the **Shopify Automation &
Admin API Toolkit** ($39.99) the **Website Migration & Replatforming System**
($29.99) and the **Agency & Client Delivery System** ($39.99) — build the site, get
it found, turn the traffic into revenue, keep it running, move it without losing
what it has, on Shopify automate the admin, and run all of it as a client
engagement. The first three are also
sold together as the **Complete Site Builder Stack** ($39.99), which is the same three
downloads on one order rather than a separate product; the Operations System and the
Shopify toolkit are sold on their own.
