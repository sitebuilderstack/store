...
def main():
    ...
    for a in m["articles"]:
        ...
        payload = {
            ...
            # New articles are created as drafts unless publication is
            # explicitly asked for. Writing to Shopify is not the same thing as
            # permission to publish, and an accidental publish cannot be undone
            # quietly — the article is in the feed and the sitemap immediately.
