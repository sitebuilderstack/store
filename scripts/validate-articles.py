...
GAP = {
    ...
    "34-maintenance.html": "claude-code-website-maintenance",
    "35-migration-seo.html": "website-migration-seo-checklist-claude-code",
    "36-playwright.html": "claude-code-playwright-website-testing",
...
TARGETS = {
    ...
    # The engagement-cycle guides: 2,000-3,200 words of prose by brief, and
    # the count here includes the pasted command output and prompts.
    "34-maintenance.html": (2000, 3600),
    "35-migration-seo.html": (2000, 3600),
    "36-playwright.html": (2000, 3600),
}
